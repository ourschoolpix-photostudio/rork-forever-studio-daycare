...
interface EditSpecialtyItemModalProps {
  visible: boolean;
  onClose: () => void;
...
export default function EditSpecialtyItemModal({ visible, onClose, onSave, editingItem }: EditSpecialtyItemModalProps) {
  ...
  const handleSave = async () => {
    ...
    try {
      onSave({
        ...
        type: editingItem.type || 'specialty',
      });
      setName('');
      setPrice('');
      onClose();
